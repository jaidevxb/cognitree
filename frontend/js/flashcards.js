...
class FlashcardManager {
    ...
    ensureFlashcardStyles() {
        ...
        style.textContent = `
            ...
            /* Scrollbar styling for flashcard modals */
            .deck-view-modal::-webkit-scrollbar,
            .deck-flashcards-modal::-webkit-scrollbar,
            .flashcard-modal::-webkit-scrollbar,
            .all-flashcards-modal::-webkit-scrollbar {
                width: 6px;
            }
            .deck-view-modal::-webkit-scrollbar-track,
            .deck-flashcards-modal::-webkit-scrollbar-track,
            .flashcard-modal::-webkit-scrollbar-track,
            .all-flashcards-modal::-webkit-scrollbar-track {
                background: rgba(0, 0, 0, 0.2);
            }
            .deck-view-modal::-webkit-scrollbar-thumb,
            .deck-flashcards-modal::-webkit-scrollbar-thumb,
            .flashcard-modal::-webkit-scrollbar-thumb,
            .all-flashcards-modal::-webkit-scrollbar-thumb {
